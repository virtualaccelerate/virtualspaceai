...
const resources = {
  en: {
    translation: {
      ...
      courses: {
        title: "Courses",
        subtitle: "Practical programs on AI, operations and growth — buy and start right away.",
        buy: "Buy course",
        watch: "Watch course",
        lessons: "lessons",
        back: "Home",
        pendingNote: "Payment is being confirmed. Access opens right after confirmation.",
        redirect: "Complete the payment in Finik — access opens after confirmation.",
        noLink: "Payment link is not configured yet. Please contact us.",
        videoSoon: "The video will be added soon.",
        soon: "New course soon",
        soonBody: "The program is being prepared.",
      },
      mentors: {
        title: "Mentors",
        subtitle: "Book an hour with an expert and get practical guidance for your business.",
        book: "Book a mentor",
        details: "Details",
        perHour: "/ hour",
        back: "All mentors",
        ...
        languages: "Languages",
        soon: "New mentors soon",
        soonBody: "We are curating experts across product, finance and growth.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Workspace logo", hint: "PNG, JPG or WebP, up to 2 MB", alt: "Workspace logo", upload: "Upload", replace: "Replace", remove: "Remove", saved: "Logo updated", removed: "Logo removed", ownerOnly: "Only the workspace owner or administrator can change the logo" },
        },
        tasks: {
          dlgEdit: "Edit task",
          dlgNew: "New task",
  ...
  ru: {
    translation: {
      ...
      courses: {
        title: "Курсы",
        subtitle: "Практические программы по ИИ, операционке и росту — покупайте и начинайте сразу.",
        buy: "Купить курс",
        watch: "Смотреть курс",
        lessons: "уроков",
        back: "На главную",
        pendingNote: "Оплата подтверждается. Доступ откроется сразу после подтверждения.",
        redirect: "Завершите оплату в Finik — доступ откроется после подтверждения.",
        noLink: "Ссылка на оплату пока не настроена. Свяжитесь с нами.",
        videoSoon: "Видео будет добавлено позже.",
        soon: "Скоро новый курс",
        soonBody: "Программа готовится.",
      },
      mentors: {
        title: "Менторы",
        subtitle: "Забронируйте час с экспертом и получите практические рекомендации для бизнеса.",
        book: "Забронировать ментора",
        details: "Подробнее",
        perHour: "/ час",
        back: "Все менторы",
        dossier: "Профессиональное досье",
        experience: "Опыт и достижения",
        topics: "Темы консультаций",
        expertise: "Направления экспертизы",
        industries: "Отрасли",
        languages: "Языки",
        soon: "Скоро новые менторы",
        soonBody: "Мы отбираем экспертов по продукту, финансам и росту.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Логотип пространства", hint: "PNG, JPG или WebP, не более 2 МБ", alt: "Логотип рабочего пространства", upload: "Загрузить", replace: "Заменить", remove: "Удалить", saved: "Логотип обновлён", removed: "Логотип удалён", ownerOnly: "Изменить логотип может владелец или администратор пространства" },
        },
        tasks: {
  ...
  kk: {
    translation: {
      ...
      courses: {
        title: "Курстар",
        subtitle: "ЖИ, операциялық жұмыс және өсу бойынша практикалық бағдарламалар — сатып алып, бірден бастаңыз.",
        buy: "Курсты сатып алу",
        watch: "Курсты көру",
        lessons: "сабақ",
        back: "Басты бетке",
        pendingNote: "Төлем расталуда. Растаудан кейін бірден қолжетімді болады.",
        redirect: "Finik-те төлемді аяқтаңыз — растаудан кейін қолжетімділік ашылады.",
        noLink: "Төлем сілтемесі әзірге бапталмаған. Бізбен байланысыңыз.",
        videoSoon: "Бейне кейінірек қосылады.",
        soon: "Жақында жаңа курс",
        soonBody: "Бағдарлама дайындалуда.",
      },
      mentors: {
        title: "Менторлар",
        subtitle: "Сарапшымен бір сағат брондап, бизнесіңізге практикалық кеңес алыңыз.",
        book: "Менторды брондау",
        details: "Толығырақ",
        perHour: "/ сағат",
        back: "Барлық менторлар",
        dossier: "Кәсіби досье",
        experience: "Тәжірибе және жетістіктер",
        topics: "Кеңес беру тақырыптары",
        expertise: "Сараптама бағыттары",
        industries: "Салалар",
        languages: "Тілдер",
        soon: "Жақында жаңа менторлар",
        soonBody: "Өнім, қаржы және өсу бойынша сарапшыларды іріктеп жатырмыз.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Кеңістік логотипі", hint: "PNG, JPG немесе WebP, 2 МБ дейін", alt: "Жұмыс кеңістігінің логотипі", upload: "Жүктеу", replace: "Ауыстыру", remove: "Жою", saved: "Логотип жаңартылды", removed: "Логотип жойылды", ownerOnly: "Логотипті тек кеңістік иесі немесе әкімшісі өзгерте алады" },
        },
        tasks: {
  ...
  ky: {
    translation: {
      ...
      newEra: {
        ...
        pill1: "Уюштуруу, талдоо",
        pill2: "Операцияга колдоо",
        pill3: "Автоматташтыруу",
      ...
      courses: {
        title: "Курстар",
        subtitle: "ЖИ, операциялык иш жана өсүү боюнча практикалык программалар — сатып алып, дароо баштаңыз.",
        buy: "Курсту сатып алуу",
        watch: "Курсту көрүү",
        lessons: "сабак",
        back: "Башкы бетке",
        pendingNote: "Төлөм текшерилүүдө. Ырастоодон кийин дароо ачылат.",
        redirect: "Finik'те төлөмдү аяктаңыз — ырастоодон кийин жеткиликтүү болот.",
        noLink: "Төлөм шилтемеси азырынча жок. Биз менен байланышыңыз.",
        videoSoon: "Видео кийинчерээк кошулат.",
        soon: "Жакында жаңы курс",
        soonBody: "Программа даярдалууда.",
      },
      mentors: {
        title: "Менторлор",
        subtitle: "Эксперт менен бир саат брондоп, бизнесиңиз үчүн практикалык кеңеш алыңыз.",
        book: "Менторду брондоо",
        details: "Толугураак",
        perHour: "/ саат",
        back: "Бардык менторлор",
        dossier: "Кесиптик досье",
        experience: "Тажрыйба жана жетишкендиктер",
        topics: "Консультация темалары",
        expertise: "Экспертиза багыттары",
        industries: "Тармактар",
        languages: "Тилдер",
        soon: "Жакында жаңы менторлор",
        soonBody: "Продукт, каржы жана өсүү боюнча эксперттерди тандап жатабыз.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Мейкиндиктин логотиби", hint: "PNG, JPG же WebP, 2 МБ чейин", alt: "Иш мейкиндигинин логотиби", upload: "Жүктөө", replace: "Алмаштыруу", remove: "Өчүрүү", saved: "Логотип жаңыртылды", removed: "Логотип өчүрүлдү", ownerOnly: "Логотипти мейкиндиктин ээси же администратору гана өзгөртө алат" },
        },
        tasks: {
  ...
  uz: {
    translation: {
      ...
      courses: {
        title: "Kurslar",
        subtitle: "AI, operatsion ish va o‘sish bo‘yicha amaliy dasturlar — sotib oling va darhol boshlang.",
        buy: "Kursni sotib olish",
        watch: "Kursni ko‘rish",
        lessons: "dars",
        back: "Bosh sahifa",
        pendingNote: "To‘lov tasdiqlanmoqda. Tasdiqdan so‘ng darhol ochiladi.",
        redirect: "To‘lovni Finik’da yakunlang — tasdiqdan so‘ng ochiladi.",
        noLink: "To‘lov havolasi hali sozlanmagan. Biz bilan bog‘laning.",
        videoSoon: "Video keyinroq qo‘shiladi.",
        soon: "Tez orada yangi kurs",
        soonBody: "Dastur tayyorlanmoqda.",
      },
      mentors: {
        title: "Mentorlar",
        subtitle: "Ekspert bilan bir soatlik uchrashuv bron qiling va biznesingiz uchun amaliy tavsiyalar oling.",
        book: "Mentorni bron qilish",
        details: "Batafsil",
        perHour: "/ soat",
        back: "Barcha mentorlar",
        dossier: "Professional dosye",
        experience: "Tajriba va yutuqlar",
        topics: "Konsultatsiya mavzulari",
        expertise: "Ekspertiza yo‘nalishlari",
        industries: "Sohalar",
        languages: "Tillar",
        soon: "Tez orada yangi mentorlar",
        soonBody: "Mahsulot, moliya va o‘sish bo‘yicha ekspertlarni tanlayapmiz.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Ish maydoni logotipi", hint: "PNG, JPG yoki WebP, 2 MB gacha", alt: "Ish maydoni logotipi", upload: "Yuklash", replace: "Almashtirish", remove: "Oʻchirish", saved: "Logotip yangilandi", removed: "Logotip oʻchirildi", ownerOnly: "Logotipni faqat ish maydoni egasi yoki administratori o‘zgartira oladi" },
        },
        tasks: {
  ...
  tg: {
    translation: {
      ...
      courses: {
        title: "Курсҳо",
        subtitle: "Барномаҳои амалӣ оид ба AI, кори оперативӣ ва рушд — харед ва фавран оғоз кунед.",
        buy: "Харидани курс",
        watch: "Тамошои курс",
        lessons: "дарс",
        back: "Ба саҳифаи асосӣ",
        pendingNote: "Пардохт тасдиқ шуда истодааст. Дастрасӣ пас аз тасдиқ кушода мешавад.",
        redirect: "Пардохтро дар Finik анҷом диҳед — дастрасӣ пас аз тасдиқ кушода мешавад.",
        noLink: "Пайванди пардохт ҳанӯз танзим нашудааст. Бо мо тамос гиред.",
        videoSoon: "Видео баъдтар илова мешавад.",
        soon: "Ба зудӣ курси нав",
        soonBody: "Барнома омода шуда истодааст.",
      },
      mentors: {
        title: "Менторҳо",
        subtitle: "Як соат бо коршинос брон кунед ва барои тиҷорати худ тавсияҳои амалӣ гиред.",
        book: "Брон кардани ментор",
        details: "Муфассал",
        perHour: "/ соат",
        back: "Ҳамаи менторҳо",
        dossier: "Досьеи касбӣ",
        experience: "Таҷриба ва дастовардҳо",
        topics: "Мавзӯъҳои машварат",
        expertise: "Самтҳои таҷриба",
        industries: "Соҳаҳо",
        languages: "Забонҳо",
        soon: "Ба зудӣ менторҳои нав",
        soonBody: "Мо коршиносонро оид ба маҳсулот, молия ва рушд интихоб мекунем.",
      },
      startups: {
      ...
      app: {
        ...
        settings: {
          ...
          logo: { title: "Логотипи фазо", hint: "PNG, JPG ё WebP, то 2 МБ", alt: "Логотипи фазои корӣ", upload: "Бор кардан", replace: "Иваз кардан", remove: "Нест кардан", saved: "Логотип нав шуд", removed: "Логотип нест шуд", ownerOnly: "Логотипро танҳо соҳиби фазо ё администратор иваз карда метавонад" },
        },
        tasks: {
